 ...
 *
 */
public class SmartScriptLexer3 {
	 ...
	 */
	public SmartScriptLexer3(String text) {
		if (text == null) {
	...
	private String extractString() {
		...
		while (currentIndex < data.length) {
			...
			if (startsWith(QUOTES)) {
				...
				} else if (currentIndex < data.length && data[currentIndex] == 'n') {
					sb.append("\n");
				} else if (currentIndex < data.length && data[currentIndex] == 'r') {
					sb.append("\r");
				} else if (currentIndex < data.length && data[currentIndex] == 't') {
					sb.append("\t");
				} else {
