...
public class ArrayIndexedCollection extends Collection {
	 ...
	 * novostvorenu kolekciju sve objekte iz dane kolekcije. Ako je veličine dane
	 * kolekcije veća od <code>16</code>, za alokaciju polja elements se koristi
	 * veličina dane kolekcije.
	 * 
	 * @param other
	 ...
	 * 
	 * @param index
	 *            indeks objekta u kolekciji koji se uklanja.
	 * @throws IndexOutOfBoundsException
	 *             ako je indeks manji od 0 ili veći od size-1.
	 */
