...
public class MyShell {
	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				String arguments = extractArguments(l.substring(commandName.length()), environment);
	...
	/**
	 * Returns single string which represents everything that user entered after the
	 * command name without MORELINES symbol.
	 * 
	 * @param l
	 *            single string which represents everything that user entered after
	 *            the command name
	 * @param env
	 *            environment object
	 * @return single string which represents everything that user entered after the
	 *         command name without MORELINES symbol
	 */
	private static String extractArguments(String l, Environment env) {
